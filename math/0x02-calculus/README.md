...
- [Files](#files)
  ...
  - [10. Derive happiness in oneself from a good day's work](#10-derive-happiness-in-oneself-from-a-good-day's-work)
...
![alt operation](./images/4.gif) where ![alt operation](./images/4a.gif)
...
![alt operation](./images/5.gif)

1. ![alt operation](./images/5a.gif)
2. ![alt operation](./images/5b.gif)
3. ![alt operation](./images/5c.gif)
4. ![alt operation](./images/5d.gif)

### 6. It is difficult to free fools from the chains they revere

**[6-voltaire](6-voltaire)**

![alt operation](./images/6.gif)

1. ![alt operation](./images/6a.gif)
2. ![alt operation](./images/6b.gif)
3. ![alt operation](./images/6c.gif)
4. ![alt operation](./images/6d.gif)

### 7. Partial truths are often more insidious than total falsehoods

**[7-partial_truths](7-partial_truths)**

![alt operation](./images/7.gif) where ![alt operation](./images/7a.gif) and ![alt operation](./images/7b.gif)

1. ![alt operation](./images/7c.gif)
2. ![alt operation](./images/7d.gif)
3. ![alt operation](./images/7e.gif)
4. ![alt operation](./images/7f.gif)

### 8. Put it all together and what do you get?

**[8-all-together](8-all-together)**

![alt operation](./images/8.gif) where ![alt operation](./images/8a.gif)

1. ![alt operation](./images/8b.gif)
2. ![alt operation](./images/8c.gif)
3. ![alt operation](./images/8d.gif)
4. ![alt operation](./images/8e.gif)
...
Write a function `def summation_i_squared(n):` that calculates ![alt operation](./images/9.gif) :
...
- `poly` is a list of coefficients representing a polynomial
  ...
  - Example: if ![alt operation](./images/10.gif), `poly` is equal to `[5, 3, 0, 1]`
...
- `poly` is a list of coefficients representing a polynomial
  - the index of the list represents the power of `x` that the coefficient belongs to
  - Example: if ![alt operation](./images/17.gif), `poly` is equal to `[5, 3, 0, 1]`
